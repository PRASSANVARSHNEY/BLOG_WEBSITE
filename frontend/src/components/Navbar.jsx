            ...
            <div className='flex items-center justify-between px-6 md:px-[200px] py-4 bg-black text-white'>
                    ...
                    <Link to="/">Blogosphere</Link> </h1>
                {
                    path == "/" && <div onChange={(e) => setPrompt(e.target.value)} className='flex justify-center items-center space-x-0'>
                        <input className='outlin-none rounded-1-xl px-3 text-black bg-white' placeholder='Search a pst' type='text' />
                ...
                <div className='hidden flex items-center justify-center space-x-2 md:space-x-4'>
                    ...
                    {user ? <div onClick={showMenu}>
                        <p className='cursor-pointer relative'></p><FaBars />{menu && <Menu />}

                    </div> : <h3><Link to='/register'>Register</Link></h3>}
                </div>
                <div onClick = {showMenu} classMenu = 'md:hidden text-lg'>
